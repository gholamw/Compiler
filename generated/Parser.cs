...
out type);
	...
	void Stat() {
		int type; string name; String name2; Obj obj; Obj obj2; int register; int register2; int reg; int index; int value; int ll1; int ll2; ll1 = 0; 
...
out type);
		...
		case 16: {
			Get();
			tab.OpenSubScope(); 
			while (la.kind == 32 || la.kind == 45 || la.kind == 46) {
				if (la.kind == 45 || la.kind == 46) {
					VarDecl();
				} else {
					ArrDecl();
...
out typeR);
	...
	static readonly bool[,] set = {
		...
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,T,T,x, x,x},
		{x,x,T,x, x,x,x,x, x,x,T,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,T, T,x,T,x, x,T,T,T, x,T,T,x, x,x},
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 43: s = "\"writeln\" expected"; break;
